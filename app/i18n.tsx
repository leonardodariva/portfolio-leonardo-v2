...
export const translations = {
  "pt-BR": {
    ...
    projects: { portfolio: "PORTFÓLIO", all: "Todos os projetos", access: "Acessar", category: "CATEGORIA", technologies: "TECNOLOGIAS", year: "ANO", status: "STATUS", context: "Contexto", role: "Meu papel", process: "Processo", solution: "Solução", learnings: "Aprendizados", gallery: "Galeria de", enlargeMain: "Ampliar mockup principal de", enlarge: "Ampliar mockup", enlarged: "Mockup ampliado de", close: "Fechar visualização ampliada" },
  ...
  en: {
    ...
    projects: { portfolio: "PORTFOLIO", all: "All projects", access: "View", category: "CATEGORY", technologies: "TECHNOLOGIES", year: "YEAR", status: "STATUS", context: "Context", role: "My role", process: "Process", solution: "Solution", learnings: "Learnings", gallery: "Gallery of", enlargeMain: "Enlarge main mockup of", enlarge: "Enlarge mockup", enlarged: "Enlarged mockup of", close: "Close enlarged view" },
