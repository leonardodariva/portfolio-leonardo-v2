...
export const translations = {
  "pt-BR": {
    ...
    form: { name: "Nome *", company: "Empresa (opcional)", optional: "Opcional", email: "E-mail *", message: "Mensagem *", namePlaceholder: "Como posso te chamar?", companyPlaceholder: "Empresa ou organização", emailPlaceholder: "seuemail@empresa.com", messagePlaceholder: "Conte brevemente sobre a oportunidade, o projeto ou como posso ajudar.", submit: "Enviar mensagem", sending: "Enviando...", success: "Mensagem enviada com sucesso! Em breve entrarei em contato.", error: "Não foi possível enviar a mensagem. Tente novamente em alguns instantes.", nameError: "Informe seu nome.", emailError: "Informe um e-mail válido.", messageError: "Escreva uma mensagem." },
    resume: { location: "Apucarana, Paraná", download: "Baixar currículo", generating: "Gerando PDF…", summary: "Resumo profissional", professional: "Competências profissionais", experience: "Experiência profissional", keyContributions: "Principais contribuições", education: "Formação e estudos", technical: "Competências técnicas" },
  ...
  en: {
    ...
    form: { name: "Name *", company: "Company (optional)", optional: "Optional", email: "Email *", message: "Message *", namePlaceholder: "What should I call you?", companyPlaceholder: "Company or organization", emailPlaceholder: "youremail@company.com", messagePlaceholder: "Briefly tell me about the opportunity, project, or how I can help.", submit: "Send message", sending: "Sending...", success: "Message sent successfully! I will be in touch soon.", error: "The message could not be sent. Please try again in a few moments.", nameError: "Enter your name.", emailError: "Enter a valid email address.", messageError: "Write a message." },
    resume: { location: "Apucarana, Paraná, Brazil", download: "Download resume", generating: "Generating PDF…", summary: "Professional summary", professional: "Professional skills", experience: "Professional experience", keyContributions: "Key contributions", education: "Education and studies", technical: "Technical skills" },
